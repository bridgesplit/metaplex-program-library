...
pub fn create_redeem_bid_instruction(
    ...
    Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new_readonly(safety_deposit_config, false),
...
pub fn create_redeem_full_rights_transfer_bid_instruction(
    ...
    Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new(fraction_mint, false),
            AccountMeta::new(auction, false),
            AccountMeta::new(bidder_metadata, false),
            ...
            AccountMeta::new(new_metadata_authority, false),
            AccountMeta::new(transfer_authority, false),
            AccountMeta::new(safety_deposit_config, false),
            AccountMeta::new(auction_extended, false),
        ],
